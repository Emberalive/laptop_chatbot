CREATE TABLE laptops (
    ...
    PRIMARY KEY (model, weight, memory_installed)
);
...
CREATE TABLE cpu (
    ...
    FOREIGN KEY (laptop_model, laptop_weight, laptop_memory) REFERENCES laptops(model, weight, memory_installed),
    PRIMARY KEY (model, laptop_model, laptop_weight, laptop_memory)
);
...
CREATE TABLE features (
    ...
    FOREIGN KEY (laptop_model, laptop_weight, laptop_memory) REFERENCES laptops(model, weight, memory_installed),
    PRIMARY KEY (laptop_model, laptop_weight, laptop_memory)
);
