...
for i in range(len(products)):
    ...
    try:
        ...
        features_query = '''
            INSERT INTO features (laptop_memory, laptop_weight, laptop_model, bluetooth, num_pad, backlit_keyboard)
            VALUES (%s, %s, %s, %s, %s, %s)
        '''
        features_values = (memory_installed, weight, laptop_name, bluetooth, num_pad, backlit)
    ...
    try:
        ...
        gpu_query = '''
            INSERT INTO gpu (laptop_memory, laptop_weight, laptop_model, model, brand)
            VALUES (%s, %s, %s, %s, %s)
        '''
        gpu_values = (memory_installed, weight, laptop_name, gpu, gpu_brand)
    ...
    try:
        ...
        storage_query = '''
        INSERT INTO storage (laptop_memory, laptop_weight, laptop_model, storage_amount, storage_type)
        VALUES(%s, %s, %s, %s, %s)
        '''
        storage_values = (memory_installed, weight, laptop_name, amount, storage_type)
    ...
    try:
        ...
        ports_query = '''
        INSERT INTO ports (laptop_memory, laptop_weight, laptop_model, hdmi, ethernet, thunderbolt, type_c, display_port)
        VALUES (%s, %s, %s, %s, %s, %s, %s, %s)
        '''
        ports_values = (memory_installed, weight, laptop_name, hdmi, ethernet, thunderbolt, usb_c, display_port)
    ...
    try:
        ...
        screen_query = '''
        INSERT INTO screen (laptop_memory, laptop_weight, laptop_model, screen_resolution, refresh_rate, touch_screen)
        VALUES(%s, %s, %s, %s, %s, %s)
        '''
        screen_values = (memory_installed, weight, laptop_name, screen_res, refresh_rate, touch_screen)
    ...
    try:
        ...
        cpu_query = '''
            INSERT INTO cpu (laptop_memory, laptop_weight, laptop_model, model, brand)
            VALUES (%s, %s, %s, %s, %s)
        '''
        cpu_values = (memory_installed, weight, laptop_name, cpu_name, cpu_brand)
